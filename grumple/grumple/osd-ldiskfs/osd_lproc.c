...
GRUMPLE_RW_ATTR(read_cache_enable);
...
GRUMPLE_RW_ATTR(writethrough_cache_enable);
...
GRUMPLE_RW_ATTR(enable_projid_xattr);
...
GRUMPLE_RW_ATTR(fallocate_zero_blocks);
...
GRUMPLE_RW_ATTR(full_scrub_ratio);
...
GRUMPLE_RW_ATTR(full_scrub_threshold_rate);
...
GRUMPLE_RO_ATTR(extent_bytes_allocation);
...
GRUMPLE_RW_ATTR(readcache_max_io_mb);
...
GRUMPLE_RW_ATTR(writethrough_max_io_mb);
...
GRUMPLE_RW_ATTR(index_in_idif);

int osd_register_proc_index_in_idif(struct osd_device *osd)
{
	struct dt_device *dt = &osd->od_dt_dev;

	return sysfs_create_file(&dt->dd_kobj, &grumple_attr_index_in_idif.attr);
}
#endif
...
static struct attribute *ldiskfs_attrs[] = {
	&grumple_attr_read_cache_enable.attr,
	&grumple_attr_writethrough_cache_enable.attr,
	&grumple_attr_enable_projid_xattr.attr,
	&grumple_attr_fstype.attr,
	&grumple_attr_mntdev.attr,
	&grumple_attr_fallocate_zero_blocks.attr,
	&grumple_attr_force_sync.attr,
	&grumple_attr_nonrotational.attr,
	&grumple_attr_index_backup.attr,
	&grumple_attr_auto_scrub.attr,
	&grumple_attr_pdo.attr,
	&grumple_attr_full_scrub_ratio.attr,
	&grumple_attr_full_scrub_threshold_rate.attr,
	&grumple_attr_extent_bytes_allocation.attr,
#ifdef LDISKFS_GET_BLOCKS_VERY_DENSE
	&grumple_attr_extents_dense.attr,
#endif
	&grumple_attr_readcache_max_filesize.attr,
	&grumple_attr_readcache_max_io_mb.attr,
	&grumple_attr_writethrough_max_io_mb.attr,
	NULL,
};
...
int osd_procfs_init(struct osd_device *osd, const char *name)
{
	 ...
	 */
	type = class_search_type(GRUMPLE_OSD_LDISKFS_NAME);
