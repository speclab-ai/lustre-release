...
#include <grumple_compat/linux/rhashtable.h>
 ...
 * @env: current grumple environment
 ...
 * @env: current grumple environment
 * @s: pointer to lu_site struct (grumple mount)
 ...
 * Because echo client and normal grumple client will share
...
/**
 * lu_env_find() - return current grumple environment
 *
...
int lu_global_init(void)
{
	...
	debugfs_create_symlink("lu_site", debugfs_grumple_root, path);
