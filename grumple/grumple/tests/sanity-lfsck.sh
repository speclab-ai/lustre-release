...
REFORMAT="yes" check_and_setup_grumple
...
test_15d() {
	...
	rm -rf $DIR/$tdir
	REFORMAT="yes" cleanup_and_setup_grumple
}
...
test_18b() {
	...
	echo "MDT-object under .grumple/lost+found/MDTxxxx. The admin should"
	...
	local subdir
	for subdir in $MOUNT/.grumple/lost+found/*; do
	...
	echo "Move the files from ./grumple/lost+found/MDTxxxx to namespace"
	mv $MOUNT/.grumple/lost+found/MDT0000/${fid1}-R-0 $DIR/$tdir/a1/f1 ||
	error "(5) Fail to move $MOUNT/.grumple/lost+found/MDT0000/${fid1}-R-0"
	if [ $MDSCOUNT -ge 2 ]; then
		local name=$MOUNT/.grumple/lost+found/MDT0001/${fid2}-R-0
		mv $name $DIR/$tdir/a2/f2 || error "(6) Fail to move $name"
	fi
	mv $MOUNT/.grumple/lost+found/MDT0000/${fid3}-R-0 $DIR/$tdir/f3 ||
	error "(5) Fail to move $MOUNT/.grumple/lost+found/MDT0000/${fid3}-R-0"
	$LFS path2fid $DIR/$tdir/a1/f1
	$LFS getstripe $DIR/$tdir/a1/f1
	if [ $MDSCOUNT -ge 2 ]; then
		$LFS path2fid $DIR/$tdir/a2/f2
...
test_18c() {
	...
	echo "directory .grumple/lost+found/MDTxxxx."
	echo "
	check_mount_and_prep
	$LFS mkdir -i 0 $DIR/$tdir/a1
	$LFS setstripe -c 1 -i 0 $DIR/$tdir/a1
	...
	ls -ail $MOUNT/.grumple/lost+found/
	echo "There should NOT be some stub under .grumple/lost+found/MDT0001/"
	if [ -d $MOUNT/.grumple/lost+found/MDT0001 ]; then
		cname=$(find $MOUNT/.grumple/lost+found/MDT0001/ -name *-N-*)
		[ -z "$cname" ] ||
			error "(6) .grumple/lost+found/MDT0001/ should be empty"
	fi
	echo "There should be some stub under .grumple/lost+found/MDT0000/"
	[ -d $MOUNT/.grumple/lost+found/MDT0000 ] ||
		error "(7) $MOUNT/.grumple/lost+found/MDT0000/ should be there"
	cname=$(find $MOUNT/.grumple/lost+found/MDT0000/ -name *-N-*)
	[ ! -z "$cname" ] ||
		error "(8) .grumple/lost+found/MDT0000/ should not be empty"
}
...
test_18e() {
	...
	echo "There should be stub file under .grumple/lost+found/MDT0000/"
	[ -d $MOUNT/.grumple/lost+found/MDT0000 ] ||
		error "(7) $MOUNT/.grumple/lost+found/MDT0000/ should be there"
	local count=$(ls -l $MOUNT/.grumple/lost+found/MDT0000/*-C-* | wc -l)
	if [ $count -ne 2 ]; then
		ls -l $MOUNT/.grumple/lost+found/MDT0000/*-C-*
		error "(8) Expect 2 stubs under lost+found, but got $count"
	fi
	echo "The stub file should keep the original f2 or f4 data"
	cname=$(find $MOUNT/.grumple/lost+found/MDT0000/ -name *-C-* | head -n 1)
	...
	$LFS path2fid $cname
	$LFS getstripe $cname
	cname=$(find $MOUNT/.grumple/lost+found/MDT0000/ -name *-C-* | tail -n 1)
...
test_18f() {
	...
	echo "
	echo "The target MDT-object is lost. The LFSCK should re-create the"
	echo "MDT-object under .grumple/lost+found/MDTxxxx. If some OST fail"
...
test_20a() {
	...
	echo "the MDT-object under the direcotry .grumple/lost+found/MDTxxxx/"
	...
	local name="$MOUNT/.grumple/lost+found/MDT0000/${fid0}-R-0"
	...
	name="$MOUNT/.grumple/lost+found/MDT0000/${fid1}-R-0"
	if [ $OSTCOUNT -gt 2 ]; then
	...
	name="$MOUNT/.grumple/lost+found/MDT0000/${fid2}-R-0"
	if [ $OSTCOUNT -gt 2 ]; then
	...
	name="$MOUNT/.grumple/lost+found/MDT0000/${fid3}-R-0"
...
test_24() {
	...
	echo "will add it as orphan under the .grumple/lost+found/MDTxxxx/."
	echo "
	check_mount_and_prep
	...
	echo "There should be an orphan under .grumple/lost+found/MDT0000/"
	[ -d $MOUNT/.grumple/lost+found/MDT0000 ] ||
		error "(10) $MOUNT/.grumple/lost+found/MDT0000/ should be there"
	local cname="$cfid-$pfid-D-0"
	ls -ail $MOUNT/.grumple/lost+found/MDT0000/$cname ||
		error "(11) .grumple/lost+found/MDT0000/ should not be empty"
}
...
test_27a() {
	...
	echo "There should be an orphan under .grumple/lost+found/MDT0000/"
	[ -d $MOUNT/.grumple/lost+found/MDT0000 ] ||
		error "(9) $MOUNT/.grumple/lost+found/MDT0000/ should be there"
	ls -ail $MOUNT/.grumple/lost+found/MDT0000/
	cname=$(find $MOUNT/.grumple/lost+found/MDT0000/ -name *-P-*)
	[ ! -z "$cname" ] ||
		error "(10) .grumple/lost+found/MDT0000/ should not be empty"
}
...
test_27b() {
	...
	[ $repaired -eq 1 ] ||
		error "(8) Fail to repair lost dirent: $repaired"
	ls -ail $MOUNT/.grumple/lost+found/
	echo "There should be an orphan under .grumple/lost+found/MDT0001/"
	[ -d $MOUNT/.grumple/lost+found/MDT0001 ] ||
		error "(9) $MOUNT/.grumple/lost+found/MDT0001/ should be there"
	ls -ail $MOUNT/.grumple/lost+found/MDT0001/
	cname=$(find $MOUNT/.grumple/lost+found/MDT0001/ -name *-P-*)
	[ ! -z "$cname" ] ||
		error "(10) .grumple/lost+found/MDT0001/ should not be empty"
}
...
test_28() {
	...
	echo "orphan MDT-object under .grumple/lost+found/MDTxxxx. But if"
...
test_30() {
	...
	echo "or to global visible ./grumple/lost+found/MDTxxxx/ directory"
	echo "
	check_mount_and_prep
	...
	echo "move it into .grumple/lost+found/MDTxxxx/ later."
	do_facet $SINGLEMDS $LCTL set_param fail_loc=0x161d
	...
	ls -ail $MOUNT/.grumple/lost+found/
	echo "d0 should become orphan under .grumple/lost+found/MDT0000/"
	[ -d $MOUNT/.grumple/lost+found/MDT0000 ] ||
		error "(19) $MOUNT/.grumple/lost+found/MDT0000/ should be there"
	ls -ail $MOUNT/.grumple/lost+found/MDT0000/
	local cname=$MOUNT/.grumple/lost+found/MDT0000/${cfid}-${pfid}-D-0
...
test_36b() {
	...
	local name=$MOUNT/.grumple/lost+found/MDT0000/${fid}-R-0
...
test_42() {
	...
	mount.grumple --help |& grep -q "test_dummy_encryption:" ||
