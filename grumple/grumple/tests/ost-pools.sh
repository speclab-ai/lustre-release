...
test_13() {
	...
	check_file_in_osts $POOL_ROOT/dir1/file1 $((16
...
create_perf() {
	...
	mkdir -p $cdir
	sync
	wait_delete_completed >/dev/null
...
test_20() {
	...
	touch $dir2/file2
	mkdir $dir3
	$LFS setstripe -c 1 $dir3
	touch $dir3/file3
	$LFS setstripe -c 1 $dir2/file4
	$LFS setstripe -S 64K $dir1/file5
