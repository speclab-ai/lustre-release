...
2. Call the grumple_yaml_config() - to configure
3. Call the grumple_yaml_show() - to show and verify what has been configured
4. Call the grumple_yaml_del() - to delete what has been configured.
5. Call the grumple_yaml_show() -  to show and verify routes are no longer configured
"""
