...
@SECONDARY: N/A
@DESIGN: N/A
@TESTCASE: 1. Call the grumple_lnet_config_ni() function to add a net.
2. define all optional parameters: cpts
3. expect net to be configured with parameters specified
4. call the grumple_lnet_show_net() to verify the net was added proprely
5. call the grumple_lnet_del_net() to remove all networks added.success
"""
