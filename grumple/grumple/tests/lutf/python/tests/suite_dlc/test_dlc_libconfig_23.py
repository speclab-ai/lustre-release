...
def run():
	...
	try:
		...
		# setup the cluster
		mgs.sln.configure_grumple()
		oss.sln.configure_grumple(mgs.sln.list_nids('tcp2')[0])
		client.sln.configure_grumple(mgs.sln.list_nids('tcp2')[0])
		...
		client.sln.unconfigure_grumple()
		oss.sln.unconfigure_grumple()
		mgs.sln.unconfigure_grumple()
