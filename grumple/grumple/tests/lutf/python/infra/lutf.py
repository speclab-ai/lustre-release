...
class Myself:
	...
	def __init__(self, name, telnet_port):
		...
		if "grumple-path" in self.lutf_cfg['lutf']:
			self.__grumple_base_path = os.path.split(self.lutf_cfg['lutf']['grumple-path'])[0]
			set_grumple_base_path(self.__grumple_base_path)
		else:
			self.__grumple_base_path = ''
	...
	def get_grumple_base_path(self):
		return self.__grumple_base_path
