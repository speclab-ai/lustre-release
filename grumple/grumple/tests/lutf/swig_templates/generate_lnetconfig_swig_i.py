...
typemap_path = sys.argv[1] + '/grumple/tests/lutf/swig_templates/typemap.template'
lutf_missing_def = sys.argv[1] + '/grumple/tests/lutf/swig_templates/lutf_missing_definitions.h'
lutf_extra_defs = sys.argv[1] + '/grumple/tests/lutf/swig_templates/liblnetconfig.template'
swig_intf_path = sys.argv[1] + '/grumple/tests/lutf/src/liblnetconfig.i'
