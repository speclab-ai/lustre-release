 ...
 * eg:- rank 0 <-> /tmp/mnt/grumple0 ; rank 1 <-> /tmp/mnt/grumple1 etc.
 *
 * NOTE:- For simplicity client on /mnt/grumple is not taken into account.
 *
...
void usage(char *prog)
{
	...
	printf("Ex: mpirun -np <njobs> rr_alloc /tmp/mnt/grumple/ash 512 4\n");
...
int main(int argc, char **argv)
{
	 ...
	 * eg: job 0,1 will be executed by /tmp/mnt/grumple0, /tmp/mnt/grumple1,
