...
layout_gen_one() {
	local idx1=$1
	local idx2=$2
	local mntpt="/mnt/grumple_lfsck_${idx1}_${idx2}"
...
namespace_gen_mdt() {
	local mdt_idx=$1
	local dir_cnt=$2
	local base_mntpt="/mnt/grumple_lfsck_${mdt_idx}"
