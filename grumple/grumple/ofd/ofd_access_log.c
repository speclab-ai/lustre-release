 ...
 * (/dev/grumple-access-log/scratch-OST0000). Accesses are described by
 ...
 *
 * A control device (/dev/grumple-access-log/control) supports an ioctl()
...
{
	struct ofd_access_log *oal = ocb->ocb_access_log;
	struct grumple_access_log_info_v1 __user *lali;
