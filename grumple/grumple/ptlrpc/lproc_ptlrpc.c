...
static struct attribute *ptlrpc_svc_attrs[] = {
	...
	&grumple_attr_req_buffer_history_len.attr,
	&grumple_attr_req_buffer_history_max.attr,
	&grumple_attr_req_buffers_max.attr,
	&grumple_attr_threads_min.attr,
	&grumple_attr_threads_started.attr,
	&grumple_attr_threads_max.attr,
	NULL,
};
...
{
	struct lprocfs_stats *svc_stats;
	__u32 op = grumple_msg_get_opc(req->rq_reqmsg);
...
void ptlrpc_lprocfs_brw(struct ptlrpc_request *req, int bytes)
{
	...
	idx = grumple_msg_get_opc(req->rq_reqmsg);
	switch (idx) {
	case OST_READ:
...
static struct attribute *ptlrpc_attrs[] = {
	...
	&grumple_attr_pmqos_latency_max_usec.attr,
	&grumple_attr_pmqos_default_duration_usec.attr,
	&grumple_attr_pmqos_use_stats_for_duration.attr,
	NULL,
};
...
int ptlrpc_lproc_init(void)
{
	...
	ptlrpc_kobj = kobject_create_and_add("ptlrpc", &grumple_kset->kobj);
	if (!ptlrpc_kobj)
		RETURN(-ENOMEM);
