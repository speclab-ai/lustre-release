...
static struct attribute *gss_attrs[] = {
	...
	&grumple_attr_krb5_allow_old_client_csum.attr,
	&grumple_attr_rsi_acquire_expire.attr,
	&grumple_attr_rsi_entry_expire.attr,
	&grumple_attr_rsi_upcall.attr,
#ifdef HAVE_GSS_KEYRING
	&grumple_attr_gss_check_upcall_ns.attr,
#endif
	NULL
};
