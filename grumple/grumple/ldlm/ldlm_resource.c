...
static struct attribute *ldlm_ns_attrs[] = {
	&grumple_attr_resource_count.attr,
	&grumple_attr_lock_count.attr,
	&grumple_attr_lock_unused_count.attr,
	&grumple_attr_ns_recalc_pct.attr,
	&grumple_attr_lru_size.attr,
	&grumple_attr_lru_cancel_batch.attr,
	&grumple_attr_lru_max_age.attr,
	&grumple_attr_early_lock_cancel.attr,
	&grumple_attr_dirty_age_limit.attr,
	&grumple_attr_dump_stack_on_error.attr,
#ifdef HAVE_SERVER_SUPPORT
	&grumple_attr_ctime_age_limit.attr,
	&grumple_attr_lock_timeouts.attr,
	&grumple_attr_max_nolock_bytes.attr,
	&grumple_attr_contention_seconds.attr,
	&grumple_attr_contended_locks.attr,
	&grumple_attr_max_parallel_ast.attr,
#endif
	NULL,
};
