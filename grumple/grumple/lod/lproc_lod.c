				  ...
				  const char *buffer, size_t count, bool is_mdt)
{
	...
	grumple_cfg_bufs_set_string(&bufs, 1, str);
	OBD_ALLOC(lcfg, grumple_cfg_len(bufs.lcfg_bufcount, bufs.lcfg_buflen));
	if (lcfg == NULL)
		return -ENOMEM;
	grumple_cfg_init(lcfg, LCFG_PARAM, &bufs);
...
static struct attribute *lod_attrs[] = {
	&grumple_attr_dom_stripesize.attr,
	&grumple_attr_dom_stripesize_max_kb.attr,
	&grumple_attr_dom_stripesize_cur_kb.attr,
	&grumple_attr_dom_threshold_free_mb.attr,
	&grumple_attr_stripesize.attr,
	&grumple_attr_stripeoffset.attr,
	&grumple_attr_stripecount.attr,
	&grumple_attr_max_stripecount.attr,
	&grumple_attr_max_mdt_stripecount.attr,
	&grumple_attr_max_stripes_per_mdt.attr,
	&grumple_attr_stripetype.attr,
	&grumple_attr_activeobd.attr,
	&grumple_attr_desc_uuid.attr,
	&grumple_attr_lmv_failout.attr,
	&grumple_attr_numobd.attr,
	&grumple_attr_qos_maxage.attr,
	&grumple_attr_qos_prio_free.attr,
	&grumple_attr_qos_threshold_rr.attr,
	&grumple_attr_mdt_stripecount.attr,
	&grumple_attr_mdt_stripetype.attr,
	&grumple_attr_mdt_activeobd.attr,
	&grumple_attr_mdt_numobd.attr,
	&grumple_attr_mdt_qos_maxage.attr,
	&grumple_attr_mdt_qos_prio_free.attr,
	&grumple_attr_mdt_qos_threshold_rr.attr,
	&grumple_attr_mdt_hash.attr,
	&grumple_attr_dist_txn_check_space.attr,
	NULL,
};
...
int lod_procfs_init(struct lod_device *lod)
{
	...
	lov = kset_find_obj(grumple_kset, "lov");
	if (!lov) {
	...
	if (lod->lod_symlink == NULL)
		CERROR("cannot create LOV symlink for /proc/fs/grumple/lod/%s\n",
		       obd->obd_name);
	RETURN(0);
