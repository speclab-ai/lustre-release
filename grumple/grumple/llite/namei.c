...
{
	struct ll_inode_info *lli = ll_i2info(inode);
	struct mdt_body *body = ((struct grumple_md *)opaque)->body;
	int rc = 0;
 ...
 *    be cleared by others calling d_grumple_revalidate).
...
/*
 * Similar to d_splice_alias(), but grumple treats invalid alias
