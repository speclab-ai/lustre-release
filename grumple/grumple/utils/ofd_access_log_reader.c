 ...
 *
 * grumple/utils/ofd_access_log_reader.c
 *
 ...
 * (see linux/grumple/grumple_access_log.h and
 * grumple/ofd/ofd_access_log.c.). By default it opens the control
...
/* /dev/grumple-access-log/scratch-OST0000 device poll callback: read entries
 * from log and print. */
...
/* Scan /dev/grumple-access-log/ for new access log devices and add to
 * epoll set. */
...
/* /dev/grumple-access-log/control device poll callback: call prescan
 * ioctl and scan /dev/grumple-access-log/ for new access log
 * devices. */
