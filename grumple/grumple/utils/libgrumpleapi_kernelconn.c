 ...
 */
int libcfs_ukuc_start(struct grumple_kernelcomm *link,
...
int libcfs_ukuc_stop(struct grumple_kernelcomm *link)
{
	int rc;
 ...
 */
int libcfs_ukuc_msg_get(struct grumple_kernelcomm *link, char *buf, int maxsize,
			int transport)
{
	struct kuc_hdr *kuch;
	int rc = 0;
