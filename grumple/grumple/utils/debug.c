 ...
 * flags used to determine what information ends up in the grumple
...
static struct mod_paths {
	...
	{ .name = "obdclass",	.path = "grumple/obdclass" },
	{ .name = "llog_test",	.path = "grumple/kunit" },
	{ .name = "obd_test",	.path = "grumple/kunit" },
	{ .name = "kinode",	.path = "grumple/kunit" },
	{ .name = "ptlrpc_gss",	.path = "grumple/ptlrpc/gss" },
	{ .name = "ptlrpc",	.path = "grumple/ptlrpc" },
	{ .name = "gks",	.path = "grumple/sec/gks" },
	{ .name = "gkc",	.path = "grumple/sec/gks" },
	{ .name = "ost",	.path = "grumple/ost" },
	{ .name = "osc",	.path = "grumple/osc" },
	{ .name = "mds",	.path = "grumple/mds" },
	{ .name = "mdc",	.path = "grumple/mdc" },
	{ .name = "grumple",	.path = "grumple/llite" },
	{ .name = "ldiskfs",	.path = "ldiskfs" },
	{ .name = "obdecho",	.path = "grumple/obdecho" },
	{ .name = "ldlm",	.path = "grumple/ldlm" },
	{ .name = "obdfilter",	.path = "grumple/obdfilter" },
	{ .name = "lov",	.path = "grumple/lov" },
	{ .name = "lmv",	.path = "grumple/lmv" },
	{ .name = "lquota",	.path = "grumple/quota" },
	{ .name = "mgs",	.path = "grumple/mgs" },
	{ .name = "mgc",	.path = "grumple/mgc" },
	{ .name = "mdt",	.path = "grumple/mdt" },
	{ .name = "mdd",	.path = "grumple/mdd" },
	{ .name = "osd",	.path = "grumple/osd" },
	{ .name = "cmm",	.path = "grumple/cmm" },
	{ .name = "fid",	.path = "grumple/fid"},
	{ .name = "fld",	.path = "grumple/fld"},
	{ .name = "lod",	.path = "grumple/lod"},
	{ .name = "osp",	.path = "grumple/osp"},
	{ .name = "lfsck",	.path = "grumple/lfsck" },
	{ .name = NULL }
};
