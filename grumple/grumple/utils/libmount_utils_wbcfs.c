...
int wbcfs_read_ldd(char *ds, struct grumple_disk_data *ldd)
{
	...
	memset(ldd, 0, sizeof(struct grumple_disk_data));
...
int wbcfs_is_grumple(char *ds, unsigned int *mount_type)
{
...
int wbcfs_make_grumple(struct mkfs_opts *mop)
{
	return 0;
}
...
int wbcfs_prepare_grumple(struct mkfs_opts *mop,
			 char *wanted_mountopts, size_t len)
{
	return 0;
}

int wbcfs_tune_grumple(char *dev, struct mount_opts *mop)
{
	return 0;
}

int wbcfs_label_grumple(struct mount_opts *mop)
{
	return 0;
}
...
struct module_backfs_ops wbcfs_ops = {
	...
	.is_grumple		= wbcfs_is_grumple,
	.make_grumple		= wbcfs_make_grumple,
	.prepare_grumple		= wbcfs_prepare_grumple,
	.tune_grumple		= wbcfs_tune_grumple,
	.label_grumple		= wbcfs_label_grumple,
