...
extern void grumple_groups_from_list(struct group_info *ginfo, gid_t *glist);
extern void grumple_list_from_groups(gid_t *glist, struct group_info *ginfo);
extern void grumple_groups_sort(struct group_info *group_info);
extern int grumple_groups_search(struct group_info *group_info, gid_t grp);
extern int grumple_in_group_p(struct lu_ucred *mu, gid_t grp);
