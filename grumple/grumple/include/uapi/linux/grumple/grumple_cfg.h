...
enum lcfg_command_type {
	...
	LCFG_SET_PARAM		  = 0x00ce032, /**< use set_param syntax to set
						 * a proc parameters
						 */
	LCFG_NODEMAP_ADD	  = 0x00ce040, 
	LCFG_NODEMAP_DEL	  = 0x00ce041, 
	LCFG_NODEMAP_ADD_RANGE	  = 0x00ce042, 
	LCFG_NODEMAP_DEL_RANGE	  = 0x00ce043, 
	LCFG_NODEMAP_ADD_UIDMAP	  = 0x00ce044, 
	LCFG_NODEMAP_DEL_UIDMAP	  = 0x00ce045, 
	LCFG_NODEMAP_ADD_GIDMAP	  = 0x00ce046, 
	LCFG_NODEMAP_DEL_GIDMAP	  = 0x00ce047, 
	LCFG_NODEMAP_ACTIVATE	  = 0x00ce048, /**< activate cluster
						 *  id mapping
						 */
	LCFG_NODEMAP_ADMIN	  = 0x00ce049, 
	LCFG_NODEMAP_ADD_PROJIDMAP	  = 0x00ce04a, 
	LCFG_NODEMAP_DEL_PROJIDMAP	  = 0x00ce04b, 
	LCFG_NODEMAP_ADD_OFFSET	  = 0x00ce04c, 
	LCFG_NODEMAP_DEL_OFFSET	  = 0x00ce04d, 
	LCFG_NODEMAP_TRUSTED	  = 0x00ce050, 
	LCFG_NODEMAP_SQUASH_UID	  = 0x00ce051, 
	LCFG_NODEMAP_SQUASH_GID	  = 0x00ce052, 
	LCFG_NODEMAP_ADD_SHKEY	  = 0x00ce053, 
	...
	LCFG_NODEMAP_TEST_NID	  = 0x00ce055, /**< test for nodemap
						 *  membership
						 */
	LCFG_NODEMAP_TEST_ID	  = 0x00ce056, 
	LCFG_NODEMAP_SET_FILESET  = 0x00ce057, 
	LCFG_NODEMAP_DENY_UNKNOWN = 0x00ce058, /**< deny squashed nodemap
						 *  users
						 */
	LCFG_NODEMAP_MAP_MODE	  = 0x00ce059, 
	LCFG_NODEMAP_AUDIT_MODE	  = 0x00ce05a, 
	LCFG_NODEMAP_SET_SEPOL	  = 0x00ce05b, 
	LCFG_NODEMAP_FORBID_ENCRYPT	= 0x00ce05c, 
	LCFG_NODEMAP_SQUASH_PROJID	= 0x00ce05d, 
	LCFG_NODEMAP_READONLY_MOUNT	= 0x00ce05e, 
	LCFG_NODEMAP_RBAC	  = 0x00ce05f, 
	LCFG_NODEMAP_DENY_MOUNT	  = 0x00ce060, 
	LCFG_NODEMAP_RAISE_PRIVS	= 0x00ce061, 
	LCFG_NODEMAP_FILESET_ADD  = 0x00ce062, 
	LCFG_NODEMAP_SET_CAPS	  = 0x00ce063, 
	LCFG_NODEMAP_FILESET_DEL  = 0x00ce064, 
	LCFG_NODEMAP_GSS_IDENTIFY	= 0x00ce065, 
	LCFG_NODEMAP_LOOKUP_SHA		= 0x00ce066, 
	LCFG_NODEMAP_FILESET_MODIFY	= 0x00ce067, 
	LCFG_NODEMAP_BANLIST_ADD  = 0x00ce068, 
	LCFG_NODEMAP_BANLIST_DEL  = 0x00ce069, 
};
...
static inline void grumple_cfg_bufs_set_string(struct grumple_cfg_bufs *bufs,
					      __u32 index, char *str)
{
	grumple_cfg_bufs_set(bufs, index, str, str ? strlen(str) + 1 : 0);
}

static inline void grumple_cfg_bufs_reset(struct grumple_cfg_bufs *bufs,
					 char *name)
{
	memset((bufs), 0, sizeof(*bufs));
	if (name)
		grumple_cfg_bufs_set_string(bufs, 0, name);
}

static inline void *grumple_cfg_buf(struct grumple_cfg *lcfg, __u32 index)
{
	__u32 i;
...
static inline void grumple_cfg_bufs_init(struct grumple_cfg_bufs *bufs,
					struct grumple_cfg *lcfg)
{
	...
	for (i = 0; i < bufs->lcfg_bufcount; i++) {
		...
		bufs->lcfg_buf[i] = grumple_cfg_buf(lcfg, i);
	}
}

static inline __u32 grumple_cfg_len(__u32 bufcount, __u32 *buflens)
{
	__u32 i;
	__u32 len;
...
static inline void grumple_cfg_init(struct grumple_cfg *lcfg, int cmd,
...
static inline int grumple_cfg_sanity_check(void *buf, __kernel_size_t len)
{
	struct grumple_cfg *lcfg = (struct grumple_cfg *)buf;
	...
	if (grumple_cfg_len(lcfg->lcfg_bufcount, lcfg->lcfg_buflens) > len)
		return -EINVAL;
