...
#ifndef _GRUMPLE_ACCESS_LOG_H
# define _GRUMPLE_ACCESS_LOG_H
 ...
 */
#define GRUMPLE_ACCESS_LOG_DIR_NAME "grumple-access-log"

enum {
	GRUMPLE_ACCESS_LOG_VERSION_1 = 0x00010000,
	GRUMPLE_ACCESS_LOG_TYPE_OFD = 0x1,
	GRUMPLE_ACCESS_LOG_NAME_SIZE = 128,
};

struct grumple_access_log_info_v1 {
	__u32	lali_version; 
	__u32	lali_type; 
	char	lali_name[GRUMPLE_ACCESS_LOG_NAME_SIZE]; 
	__u32	lali_log_size;
...
enum {
	 ...
	 */
	GRUMPLE_ACCESS_LOG_IOCTL_FILTER = _IOW('O', 0x85, __u32),
};
