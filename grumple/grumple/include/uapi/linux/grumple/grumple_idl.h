 ...
 * that are used in interfaces with userspace should go in grumple_user.h.
 *
...
extern void grumple_lma_swab(struct grumple_mdt_attrs *lma);
extern void grumple_lma_init(struct grumple_mdt_attrs *lma,
			    const struct lu_fid *fid,
			    __u32 compat, __u32 incompat);
extern void grumple_loa_swab(struct grumple_ost_attrs *loa,
			    bool to_cpu);
extern void grumple_loa_init(struct grumple_ost_attrs *loa,
			    const struct lu_fid *fid,
			    __u32 compat, __u32 incompat);
...
extern void grumple_hsm_swab(struct hsm_attrs *attrs);
...
static inline bool grumple_handle_is_used(const struct grumple_handle *lh)
{
	return lh->cookie != 0;
}

static inline bool grumple_handle_equal(const struct grumple_handle *lh1,
				       const struct grumple_handle *lh2)
{
	return lh1->cookie == lh2->cookie;
}

static inline void grumple_handle_copy(struct grumple_handle *tgt,
				      const struct grumple_handle *src)
{
...
#define grumple_msg grumple_msg_v2


struct grumple_msg_v2 {
	__u32 lm_bufcount;	
	__u32 lm_secflvr;	
	__u32 lm_magic;		
	__u32 lm_repsize;	
...
#define MSG_CLIENT_BANNED	0x0100 
#define MSG_PACK_UID_GID	0x0200 
#define MSG_PACK_PROJID		0x0400 
...
struct ptlrpc_body_v3 {
	struct grumple_handle pb_handle;
	__u32 pb_type;		
	__u32 pb_version;	
	__u32 pb_opc;		
	__u32 pb_status;	
...
#define OBD_CONNECT_MGS_NIDLIST		       0x40ULL 
#define OBD_CONNECT_ACL			       0x80ULL 
#define OBD_CONNECT_XATTR		      0x100ULL 
#define OBD_CONNECT_LARGE_ACL		      0x200ULL 


#define OBD_CONNECT_OLD_FALLOC		      0x400ULL 
#define OBD_CONNECT_TRANSNO		      0x800ULL 
#define OBD_CONNECT_IBITS		     0x1000ULL 
#define OBD_CONNECT_BARRIER		     0x2000ULL 
...
#define OBD_CONNECT_MAX_EASIZE		0x800000000ULL 
#define OBD_CONNECT_FULL20	       0x1000000000ULL 
#define OBD_CONNECT_LAYOUTLOCK	       0x2000000000ULL 
#define OBD_CONNECT_64BITHASH	       0x4000000000ULL 
#define OBD_CONNECT_MAXBYTES	       0x8000000000ULL 
#define OBD_CONNECT_IMP_RECOV	      0x10000000000ULL 
#define OBD_CONNECT_JOBSTATS	      0x20000000000ULL 
#define OBD_CONNECT_UMASK	      0x40000000000ULL 

#define OBD_CONNECT_EINPROGRESS	      0x80000000000ULL

#define OBD_CONNECT_GRANT_PARAM	     0x100000000000ULL
#define OBD_CONNECT_FLOCK_OWNER	     0x200000000000ULL 
#define OBD_CONNECT_LVB_TYPE	     0x400000000000ULL 
#define OBD_CONNECT_NANOSEC_TIME     0x800000000000ULL 
#define OBD_CONNECT_LIGHTWEIGHT	    0x1000000000000ULL 
#define OBD_CONNECT_SHORTIO	    0x2000000000000ULL 
#define OBD_CONNECT_PINGLESS	    0x4000000000000ULL 
#define OBD_CONNECT_FLOCK_DEAD	    0x8000000000000ULL 
#define OBD_CONNECT_DISP_STRIPE	   0x10000000000000ULL 
#define OBD_CONNECT_OPEN_BY_FID	   0x20000000000000ULL /* open by FID won't pack
							* name in request
							*/
#define OBD_CONNECT_LFSCK	   0x40000000000000ULL 
#define OBD_CONNECT_UNLINK_CLOSE  0x100000000000000ULL 
#define OBD_CONNECT_MULTIMODRPCS  0x200000000000000ULL /* allow multiple change
							* RPCs in parallel
							*/
#define OBD_CONNECT_DIR_STRIPE	  0x400000000000000ULL 
#define OBD_CONNECT_SUBTREE	  0x800000000000000ULL 

#define OBD_CONNECT_BULK_MBITS	 0x2000000000000000ULL 
#define OBD_CONNECT_OBDOPACK	 0x4000000000000000ULL 
#define OBD_CONNECT_FLAGS2	 0x8000000000000000ULL 

#define OBD_CONNECT2_FILE_SECCTX		0x1ULL 
#define OBD_CONNECT2_LOCKAHEAD			0x2ULL 
#define OBD_CONNECT2_DIR_MIGRATE		0x4ULL 
#define OBD_CONNECT2_SUM_STATFS			0x8ULL 
#define OBD_CONNECT2_OVERSTRIPING	       0x10ULL 
#define OBD_CONNECT2_FLR		       0x20ULL 
#define OBD_CONNECT2_WBC_INTENTS	       0x40ULL 
#define OBD_CONNECT2_LOCK_CONVERT	       0x80ULL 
#define OBD_CONNECT2_ARCHIVE_ID_ARRAY	      0x100ULL 
#define OBD_CONNECT2_INC_XID		      0x200ULL 
#define OBD_CONNECT2_SELINUX_POLICY	      0x400ULL 
#define OBD_CONNECT2_LSOM		      0x800ULL 
#define OBD_CONNECT2_PCC		     0x1000ULL 
#define OBD_CONNECT2_CRUSH		     0x2000ULL 
#define OBD_CONNECT2_ASYNC_DISCARD	     0x4000ULL 
#define OBD_CONNECT2_ENCRYPT		     0x8000ULL 
#define OBD_CONNECT2_FIDMAP		    0x10000ULL 
#define OBD_CONNECT2_GETATTR_PFID	    0x20000ULL 
#define OBD_CONNECT2_LSEEK		    0x40000ULL 
#define OBD_CONNECT2_DOM_LVB		    0x80000ULL 
#define OBD_CONNECT2_REP_MBITS		   0x100000ULL 
#define OBD_CONNECT2_MODE_CONVERT	   0x200000ULL 
#define OBD_CONNECT2_BATCH_RPC		   0x400000ULL 
#define OBD_CONNECT2_PCCRO		   0x800000ULL 
#define OBD_CONNECT2_MNE_TYPE		  0x1000000ULL 
#define OBD_CONNECT2_LOCK_CONTENTION	  0x2000000ULL 
#define OBD_CONNECT2_ATOMIC_OPEN_LOCK	  0x4000000ULL 
#define OBD_CONNECT2_ENCRYPT_NAME	  0x8000000ULL 

#define OBD_CONNECT2_DMV_IMP_INHERIT	 0x20000000ULL
#define OBD_CONNECT2_ENCRYPT_FID2PATH	 0x40000000ULL 

#define OBD_CONNECT2_REPLAY_CREATE	 0x80000000ULL 

#define OBD_CONNECT2_LARGE_NID		0x100000000ULL
#define OBD_CONNECT2_COMPRESS		0x200000000ULL 
/* only ZFS servers require a change to support unaligned DIO, so this flag is
 * ignored for ldiskfs servers
 */
#define OBD_CONNECT2_UNALIGNED_DIO	0x400000000ULL 
#define OBD_CONNECT2_CONN_POLICY	0x800000000ULL 
#define OBD_CONNECT2_SPARSE            0x1000000000ULL 
#define OBD_CONNECT2_MIRROR_ID_FIX     0x2000000000ULL 
#define OBD_CONNECT2_UPDATE_LAYOUT     0x4000000000ULL 
#define OBD_CONNECT2_READDIR_OPEN	0x8000000000ULL 
#define OBD_CONNECT2_FLR_EC	       0x10000000000ULL	
...
enum mds_ibits_locks {
	MDS_INODELOCK_NONE	= 0x000000000, 
	MDS_INODELOCK_LOOKUP	= 0x000000001, /* For namespace, dentry etc Was
						* used to protect permission
						* (mode, owner, group, etc)
						* before 2.4.
						*/
	MDS_INODELOCK_UPDATE	= 0x000000002, 
	MDS_INODELOCK_OPEN	= 0x000000004, 
	MDS_INODELOCK_LAYOUT	= 0x000000008, 
	...
	MDS_INODELOCK_XATTR	= 0x000000020, 
	MDS_INODELOCK_DOM	= 0x000000040, 
...
struct obd_connect_data {
	...
	__u32 ocd_index;	 
	__u32 ocd_brw_size;	 
	enum mds_ibits_locks ocd_ibits_known; 
	__u8  ocd_grant_blkbits; 
	__u8  ocd_grant_inobits; 
	__u16 ocd_grant_tax_kb;	 
	__u32 ocd_grant_max_blks;
	__u64 ocd_transno;	 
	__u32 ocd_group;	 
	 ...
	 */
	__u16 ocd_maxmodrpcs;	 
	__u8  ocd_conn_policy;	 
	__u8  padding0;		 
	__u32 padding1;		 
	__u64 ocd_connect_flags2;
	__u64 ocd_compr_type;	 
	__u64 padding4;		 
	__u64 padding5;		 
	__u64 padding6;		 
	__u64 padding7;		 
 ...
 * updates grumple_swab_connect(), along with the matching OBD_CONNECT flag,
 * and updates wiretests accordingly,so it can be approved and landed easily
...
enum obdo_flags {
	...
	OBD_FL_DELORPHAN    = 0x00000004, 
	OBD_FL_NORPC        = 0x00000008, 
	OBD_FL_IDONLY       = 0x00000010, 
	OBD_FL_RECREATE_OBJS = 0x00000020, 
	OBD_FL_DEBUG_CHECK  = 0x00000040, 
	OBD_FL_NO_PRJQUOTA  = 0x00000080, /* the object's project is over
					   * quota
					   */
	OBD_FL_NO_USRQUOTA  = 0x00000100, 
	OBD_FL_NO_GRPQUOTA  = 0x00000200, 
	OBD_FL_CREATE_CROW  = 0x00000400, 
	OBD_FL_SRVLOCK      = 0x00000800, 
	OBD_FL_CKSUM_CRC32  = 0x00001000, 
	OBD_FL_CKSUM_ADLER  = 0x00002000, 
	OBD_FL_CKSUM_CRC32C = 0x00004000, 
	OBD_FL_CKSUM_T10IP512  = 0x00005000, 
	OBD_FL_CKSUM_T10IP4K   = 0x00006000, 
	OBD_FL_CKSUM_T10CRC512 = 0x00007000, 
	OBD_FL_CKSUM_T10CRC4K  = 0x00008000, 
	OBD_FL_CKSUM_RSVD3  = 0x00010000, 
	OBD_FL_SHRINK_GRANT = 0x00020000, 
	OBD_FL_MMAP         = 0x00040000, /* object is mmapped on the client.
					   *  XXX: obsoleted - reserved for old
					   *  clients prior than 2.2
					   */
	OBD_FL_RECOV_RESEND = 0x00080000, 
	OBD_FL_NOSPC_BLK    = 0x00100000, 
	OBD_FL_FLUSH	    = 0x00200000, 
	OBD_FL_SHORT_IO	    = 0x00400000, 
	OBD_FL_ROOT_SQUASH  = 0x00800000, 
	OBD_FL_ROOT_PRJQUOTA  = 0x01000000, 
...
#define OBD_MD_DOM_SIZE    (0x00001000ULL) 
#define OBD_MD_FLNLINK     (0x00002000ULL) 
#define OBD_MD_FLPARENT    (0x00004000ULL) 
#define OBD_MD_LAYOUT_VERSION (0x00008000ULL) 
...
#define OBD_MD_FLPRJQUOTA  (0x00400000ULL) 
...
#define OBD_MD_TSTATE      (0x0000000800000000ULL) 
...
#define OBD_MD_FLAGSTATFS    (0x0000010000000000ULL) 
...
#define OBD_MD_FLGETATTRLOCK (0x0000200000000000ULL) /* Get IOEpoch attributes
						      ...
						      */
#define OBD_MD_FLOBJCOUNT    (0x0000400000000000ULL) 

#define OBD_MD_FLDATAVERSION (0x0010000000000000ULL) 
#define OBD_MD_CLOSE_INTENT_EXECED (0x0020000000000000ULL) 

#define OBD_MD_DEFAULT_MEA   (0x0040000000000000ULL) 
#define OBD_MD_FLOSTLAYOUT   (0x0080000000000000ULL) 
#define OBD_MD_FLPROJID      (0x0100000000000000ULL) 
#define OBD_MD_SECCTX        (0x0200000000000000ULL) 
#define OBD_MD_FLLAZYSIZE    (0x0400000000000000ULL) 
#define OBD_MD_FLLAZYBLOCKS  (0x0800000000000000ULL) 
#define OBD_MD_FLBTIME       (0x1000000000000000ULL) 
#define OBD_MD_ENCCTX        (0x2000000000000000ULL) 
...
#define OBD_BRW_ROOT_PRJQUOTA 0x10000 
#define OBD_BRW_RDMA_ONLY    0x20000 
#define OBD_BRW_SYS_RESOURCE 0x40000 
#define OBD_BRW_COMPRESSED   0x80000 
...
struct quota_body {
	...
	__u64		qb_usage;   
	__u64		qb_slv_ver; 
	struct grumple_handle	qb_lockh;     
	struct grumple_handle	qb_glb_lockh; 
	__u64		qb_padding1[4];
};
...
#define QUOTA_DQACQ_FL_ACQ	0x1  
#define QUOTA_DQACQ_FL_PREACQ	0x2  
#define QUOTA_DQACQ_FL_REL	0x4  
#define QUOTA_DQACQ_FL_REPORT	0x8  


enum lquota_type {
	LQUOTA_TYPE_USR	= 0x00, 
	LQUOTA_TYPE_GRP	= 0x01, 
	LQUOTA_TYPE_PRJ	= 0x02, 
	LQUOTA_TYPE_MAX
};
...
#define LQUOTA_FL_EDQUOT 0x1 


struct lquota_lvb {
	__u64	lvb_flags;	
	__u64	lvb_id_may_rel; 
	__u64	lvb_id_rel;     
	__u64	lvb_id_qunit;   
	__u64	lvb_pad1;
};
...
#define lvb_glb_ver  lvb_id_may_rel 
...
struct mdt_body {
	...
	struct grumple_handle mbo_open_handle;
	__u64	mbo_valid;
	__u64	mbo_size; 
	__s64	mbo_mtime;
	__s64	mbo_atime;
...
struct mdt_ioepoch {
	struct grumple_handle mio_open_handle;
	__u64 mio_unused1; 
	__u32 mio_unused2; 
	__u32 mio_padding;
};
 ...
 */
enum mds_attr_flags {
	MDS_ATTR_MODE =		      0x1ULL, 
	MDS_ATTR_UID =		      0x2ULL, 
	MDS_ATTR_GID =		      0x4ULL, 
	MDS_ATTR_SIZE =		      0x8ULL, 
	MDS_ATTR_ATIME =	     0x10ULL, 
	MDS_ATTR_MTIME =	     0x20ULL, 
	MDS_ATTR_CTIME =	     0x40ULL, 
	MDS_ATTR_ATIME_SET =	     0x80ULL, 
	MDS_ATTR_MTIME_SET =	    0x100ULL, 
	MDS_ATTR_FORCE =	    0x200ULL, 
	MDS_ATTR_ATTR_FLAG =	    0x400ULL, 
	MDS_ATTR_KILL_SUID =	    0x800ULL, 
	MDS_ATTR_KILL_SGID =	   0x1000ULL, 
	MDS_ATTR_CTIME_SET =	   0x2000ULL, 
	MDS_ATTR_FROM_OPEN =	   0x4000ULL, 
	MDS_ATTR_BLOCKS =	   0x8000ULL, 
	MDS_ATTR_PROJID =	  0x10000ULL, 
	MDS_ATTR_LSIZE =	  0x20000ULL, 
	MDS_ATTR_LBLOCKS =	  0x40000ULL, 
	MDS_ATTR_OVERRIDE =	0x2000000ULL, 
};
...
struct mdt_rec_create {
	...
	struct grumple_handle cr_open_handle_old; 
	__s64		cr_time;
	union {
		__u64		cr_rdev;
		__u32		cr_archive_id;
...
struct mdt_rec_resync {
	...
	struct grumple_handle rs_lease_handle;	
	__s64		rs_padding1;	
	__s64		rs_padding2;	
	__u64           rs_padding3;	
	__u64           rs_padding4;	
	 ...
	 */
	__u32           rs_mirror_id_new; 
	__u16           rs_mirror_id_old; 
	__u16           rs_padding9;	
};
 ...
 * will be broken in grumple_swab_mdt_rec_reint().
 *
 * If you add new members in other mdt_reint_xxx structres and need to use the
 * rr_padding_x fields, then update grumple_swab_mdt_rec_reint() also.
 */
struct mdt_rec_reint {
	...
	__u32           rr_flags_h;
	__u32           rr_umask;
	__u16		rr_mirror_id_old; 
	__u16           rr_padding_4; 
};
#define rr_mirror_id_new rr_umask

#define LMV_DESC_QOS_MAXAGE_DEFAULT 60  
...
#define LMV_MAGIC_V1	0x0CD20CD0    
#define LMV_MAGIC	LMV_MAGIC_V1


#define LMV_MAGIC_STRIPE 0x0CD40CD0 
#define LMV_MAGIC_FOREIGN 0x0CD50CD0 
...
#define LOV_DESC_QOS_MAXAGE_DEFAULT 5  
...
struct lov_desc {
	__u32 ld_tgt_count;		
	__u32 ld_active_tgt_count;	
	__s32 ld_default_stripe_count;	
	enum lov_pattern ld_pattern;	
	__u64 ld_default_stripe_size;	
	__s64 ld_default_stripe_offset;	
	__u32 ld_padding_0;		
	__u32 ld_qos_maxage;		
	__u32 ld_padding_1;		
	__u32 ld_padding_2;		
...
#define LCK_MINMODE	LCK_MODE_MIN 
#define LCK_MAXMODE	LCK_MODE_MAX 
...
#define LDLM_TYPE_MAX	LDLM_TYPE_END 
...
struct ldlm_inodebits {
	...
	union {
		...
		enum mds_ibits_locks cancel_bits; 
	};
	__u64 li_gid;
	__u32 li_padding;
	__u32 li_initiator_id; 
};
...
enum ldlm_intent_flags {
	IT_OPEN        = 0x00000001,
	IT_CREAT       = 0x00000002,
	IT_OPEN_CREAT  = IT_OPEN | IT_CREAT, 
...
struct ldlm_request {
	...
	struct grumple_handle	lock_handle[]; 
};
...
enum mgs_nidlist_flags {
	NIDLIST_APPEND		= 0x00000001, 
	NIDLIST_IN_BULK		= 0x00000002, 
	NIDLIST_COMPRESSED	= 0x00000004, 
};
...
struct mgs_nidtbl_entry {
	...
	__u8		mne_nid_count;	
	union {
		DECLARE_FLEX_ARRAY(lnet_nid_t, nids); 
...
struct mgs_config_body {
	char     mcb_name[MTI_NAME_MAXLEN]; 
	__u64    mcb_offset;    
	__u16    mcb_type;      
	union {
		__u8	mcb_nm_cur_pass;  
		__u8	mcb_rec_nid_size; 
	};
	__u8     mcb_bits;      
	__u32    mcb_units;     
};
...
enum llog_ctxt_id {
	...
	LLOG_CHANGELOG_ORIG_CTXT = 12, 
	LLOG_CHANGELOG_REPL_CTXT = 13, 
	
	LLOG_CHANGELOG_USER_ORIG_CTXT = 14,
	LLOG_AGENT_ORIG_CTXT = 15, 
	LLOG_UPDATELOG_ORIG_CTXT = 16, 
	LLOG_UPDATELOG_REPL_CTXT = 17, 
	LLOG_MAX_CTXTS
};
...
struct llog_changelog_rec {
	...
	struct llog_rec_tail cr_do_not_use; 
} __attribute__((packed));

#define CHANGELOG_USER_PREFIX "cl"
#define CHANGELOG_USER_NAMELEN 16 
#define CHANGELOG_USER_NAMELEN_FULL 30 
...
struct llog_agent_req_rec {
	struct llog_rec_hdr	arr_hdr;	
	__u32			arr_status;	
						/* must match enum
						 * agent_req_status
						 */
	__u32			arr_archive_id;	
	__u64			arr_flags;	
	__u64			arr_compound_id; /** < compound cookie,
						  * ignored
						  */
	__u64			arr_req_create;	
	__u64			arr_req_change;	
	struct hsm_action_item	arr_hai;	
...
struct obdo {
	...
	__u32			o_stripe_idx;	
	__u32			o_parent_ver;
	struct grumple_handle	o_handle;	
...
#define II_END_OFF	MDS_DIR_END_OFF 
...
union lu_page {
	struct lu_dirpage	lp_dir; 
	struct lu_idxpage	lp_idx; 
...
enum layout_intent_opc {
	...
	LAYOUT_INTENT_PCCRO_SET	= 7,	
	LAYOUT_INTENT_PCCRO_CLEAR = 8,	
	LAYOUT_INTENT_CHANGE    = 9,    
};
 ...
 * update_opcode in grumple/target/out_lib.c.
 */
enum update_type {
	OUT_START		= 0,
	OUT_CREATE		= 1,
...
enum update_flag {
	UPDATE_FL_OST		= 0x00000001,	
	UPDATE_FL_SYNC		= 0x00000002,	
	UPDATE_FL_COMMITTED	= 0x00000004,	
	UPDATE_FL_NOLOG		= 0x00000008	
};
...
struct object_update {
	__u16		ou_type;		
	__u16		ou_params_count;	
	__u32		ou_result_size;		
	__u32		ou_flags;		
	__u32		ou_padding1;		
	__u64		ou_batchid;		
	struct lu_fid	ou_fid;			
	struct object_update_param ou_params[]; 
};
...
struct batch_update_request {
	 ...
	 * request are packed after padded grumple_msg.lm_buflens[] arrary, thus
	 * it can locate the next request message via the function
	 * @batch_update_reqmsg_next() in grumple/include/obj_update.h
	 */
	struct grumple_msg	burq_reqmsg[];
};
...
struct batch_update_reply {
	 ...
	 * @batch_update_repmsg_next() in grumple/include/obj_update.h
	 */
	struct grumple_msg	burp_repmsg[];
};
...
struct close_data {
	struct grumple_handle	cd_handle;
...
enum nodemap_mapping_modes {
	NODEMAP_MAP_BOTH_LEGACY	= 0x0,  
	NODEMAP_MAP_UID		= 0x01,
	NODEMAP_MAP_GID		= 0x02,
	NODEMAP_MAP_BOTH	= 0x03, 
...
enum nodemap_raise_privs {
	...
	NODEMAP_RAISE_PRIV_ALL	= 0xFFFFFFFF, 
};
