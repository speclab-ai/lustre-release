 ...
 */
#define LDLM_FL_SPECULATIVE		0x0000000000000010ULL 
 ...
 * is for clients (like libgrumple) that cannot be expected to reliably
 ...
 */
#define LDLM_FL_CONVERTING              0x0000000002000000ULL 
 ...
 */
#define LDLM_FL_NO_EXPANSION		0x0000000020000000ULL 
