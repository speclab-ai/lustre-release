...
enum grumple_imp_state {
	GRUMPLE_IMP_CLOSED	= 1,
	GRUMPLE_IMP_NEW		= 2,
	GRUMPLE_IMP_DISCON	= 3,
	GRUMPLE_IMP_CONNECTING	= 4,
	GRUMPLE_IMP_REPLAY	= 5,
	GRUMPLE_IMP_REPLAY_LOCKS	= 6,
	GRUMPLE_IMP_REPLAY_WAIT	= 7,
	GRUMPLE_IMP_RECOVER	= 8,
	GRUMPLE_IMP_FULL		= 9,
	GRUMPLE_IMP_EVICTED	= 10,
	GRUMPLE_IMP_IDLE		= 11,
	GRUMPLE_IMP_LAST
};
...
static inline const char *ptlrpc_import_state_name(enum grumple_imp_state state)
{
	...
	LASSERT(state < GRUMPLE_IMP_LAST);
