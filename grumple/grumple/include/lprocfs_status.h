...
#include <grumple_compat/linux/linux-fs.h>
...
extern struct proc_dir_entry *proc_grumple_root;
extern struct dentry *debugfs_grumple_root;
extern struct kset *grumple_kset;
