...
enum grumple_sec_part sptlrpc_target_sec_part(struct obd_device *obd);
...
int sptlrpc_rule_set_choose(struct sptlrpc_rule_set *rset,
			    enum grumple_sec_part from,
			    enum grumple_sec_part to,
			    struct lnet_nid *nid,
			    struct sptlrpc_flavor *sf);
void sptlrpc_rule_set_dump(struct sptlrpc_rule_set *set);

int  sptlrpc_process_config(struct grumple_cfg *lcfg);
...
struct ptlrpc_sec_cops {
	 ...
	 * reply which be transformed from \a grumple_msg_size of clear text.
	 *
 ...
 */
void _sptlrpc_enlarge_msg_inplace(struct grumple_msg *msg, int segment,
				  int newsize);
...
int sptlrpc_unpack_user_desc(struct grumple_msg *req, int offset, int swabbed);
