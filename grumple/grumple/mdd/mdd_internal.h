...
struct mdd_device {
	...
	struct mdd_object               *mdd_dot_grumple;
	struct mdd_dot_grumple_objs       mdd_dot_grumple_objs;
...
extern int grumple_posix_acl_permission(struct lu_ucred *mu,
				       const struct lu_attr *la,
				       unsigned int may_mask,
				       posix_acl_xattr_entry *entry,
				       int count);
extern int grumple_posix_acl_chmod_masq(posix_acl_xattr_entry *entry,
				       __u32 mode, int count);
extern int grumple_posix_acl_create_masq(posix_acl_xattr_entry *entry,
					__u32 *pmode, int count);
extern int grumple_posix_acl_equiv_mode(posix_acl_xattr_entry *entry,
